...
classifier = Classifier("C:/Users/Gangoni Venkatesh/OneDrive/Desktop/model/converted_keras/keras_model.h5","C:/Users/Gangoni Venkatesh/OneDrive/Desktop/model/converted_keras/labels.txt")
offset = 20
imgSize = 300
counter = 0

labels = ["All the best","Hello","I Love You","No","Okay","Sorry","Thank you"]
...
csv_file = open('C:/Users/Gangoni Venkatesh/OneDrive/Desktop/SIGN-LANGUAGE DETECTION/sign_language_predictions.csv', mode='w', newline='') 
...
while True:
    ...
    if key == ord('s') and hands:
        ...
        save_path = os.path.join(os.getcwd(), "C:/Users/Gangoni Venkatesh/OneDrive/Desktop/SIGN-LANGUAGE DETECTION/SavedCrops", f"Crop_{time.time()}.jpg")
        success = cv2.imwrite(save_path, imgCrop)
        print("Image saved:", success, "at", save_path)
    elif key == ord('q'):
        break
